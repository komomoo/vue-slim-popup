...
},{}],"../src/SlimPopup/mixins/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/SlimPopup/index.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $d00180 = exports.default || module.exports;
      
      if (typeof $d00180 === 'function') {
        $d00180 = $d00180.options;
      }
    
        /* template */
        Object.assign($d00180, (function () {
          var render = function() {
  var _vm = this
      ...
      _c("transition", { attrs: { name: _vm.popupTransition } }, [
        _c(
          "div",
          {
            ...
            class: [
              _vm.c("__popup"),
              _vm.c("__popup--" + _vm.popupPosition)
            ].concat(_vm.popupClass),
          ...
          [_vm.popupBodyRenderState ? _vm._t("default") : _vm._e()],
          2
        )
      ])
    ],
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d00180', $d00180);
          } else {
            api.reload('$d00180', $d00180);
          }
        }
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","./mixins":"../src/SlimPopup/mixins/index.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../src/index.js":[function(require,module,exports) {
"use strict";
...
var _SlimPopup = _interopRequireDefault(require("./SlimPopup"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_SlimPopup.default.install = function (Vue) {
  Vue.component(_SlimPopup.default.name, _SlimPopup.default);
};

var _default = _SlimPopup.default;
exports.default = _default;
},{"./SlimPopup":"../src/SlimPopup/index.vue"}],"App.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    // 显示
    popupShow: function popupShow(index) {
...
exports.default = _default;
        var $f7f576 = exports.default || module.exports;
      
      if (typeof $f7f576 === 'function') {
        $f7f576 = $f7f576.options;
      }
    
        /* template */
        Object.assign($f7f576, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      ...
      _c(
        "SlimPopup",
        {
          attrs: {
            show: _vm.show,
            "popup-transition": _vm.popupTransition,
            "popup-class": ["popup"]
          },
          on: {
        ...
        [
          _c("h2", { staticStyle: { color: "#6D7A80" } }, [
            _vm._v("这里是一个插槽，可以放置任何元素")
          ]),
          _vm._v(" "),
          _c(
            "button",
            { staticClass: "close-btn", on: { click: _vm.popupHide } },
            [_vm._v("X")]
          )
        ]
      ),
      ...
      _c(
        ...
        [
          _c("h2", { staticStyle: { color: "#6D7A80" } }, [_vm._v("滚动元素")]),
          _vm._v(" "),
          _c("h2", { staticStyle: { color: "#6D7A80" } }, [_vm._v("滚动元素")]),
          _vm._v(" "),
          _c("h2", { staticStyle: { color: "#6D7A80" } }, [_vm._v("滚动元素")]),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f7f576', $f7f576);
          } else {
            api.reload('$f7f576', $f7f576);
          }
        }
...
},{"../src":"../src/index.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
